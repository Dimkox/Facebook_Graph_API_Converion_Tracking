 ...
 * Now with logging capabilities.
 */

require_once __DIR__ . '/config.php';

// Стабильные: Определяем путь к лог-файлу.
...
class FacebookCapiHandler
{
    // ... (весь код класса из предыдущего шага без изменений) ...
    // ... (конструктор, buildEventPayload, executeApiRequest) ...
    private $pixelId;
    private $accessToken;
    private $apiVersion;
    ...
    public function sendEvent(array $params): array
    {
        ...
        // Шаг логирования: Сохраняем транзакцию в лог.
    ...
    /**
     * Записывает данные о транзакции в лог-файл.
     */
...
try {
    ...
    unset($result['sent_data']); // Не показываем это в ответе Keitaro, только в логе
