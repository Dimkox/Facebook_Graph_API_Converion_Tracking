<?php
// Стабильные: Путь к лог-файлу и словарь с пояснениями.
...
<body>
    <div class="container">
        ...
        if (!file_exists(LOG_FILE)) {
            ...
            $log_lines = array_reverse($log_lines); // Показываем последние логи первыми
        ...
        <div class="log-entry">
            ...
            <div class="log-body">
                ...
                <?php if (isset($log['facebook_response']) && !empty($log['facebook_response'])): ?>
                ...
                <?php else: ?>
                    <p>Ответ от Facebook отсутствует или пуст.</p>
                <?php endif; ?>
            </div>
        </div>
        <?php
